  ...
  _createClass(Tag, [{
    ...
    value: function render() {
      ...
      var _a = this.props,
          ...
          style = _a.style,
          size = _a.size,
          otherProps = __rest(_a, ["prefixCls", "closable", "color", "className", "children", "style", "size"]);

      var closeIcon = closable ? /*#__PURE__*/React.createElement(CloseO, {
        onClick: this.close
      }) : '';
      var isPresetColor = this.isPresetColor(color);
      var classString = classNames(prefixCls, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-").concat(color), isPresetColor), _defineProperty(_classNames, "".concat(prefixCls, "-has-color"), color && !isPresetColor), _defineProperty(_classNames, "".concat(prefixCls, "-close"), this.state.closing), _defineProperty(_classNames, "".concat(prefixCls, "-").concat(size), size), _classNames), className); // fix https://fb.me/react-unknown-prop
