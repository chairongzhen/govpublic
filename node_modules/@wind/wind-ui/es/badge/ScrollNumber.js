  ...
  _createClass(ScrollNumber, [{
    ...
    value: function render() {
      ...
      var newProps = _extends(_extends({}, restProps), {
        className: classNames((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls), !!prefixCls), _defineProperty(_classNames, "".concat(className), !!className), _classNames)),
        title: count
      ...
      return /*#__PURE__*/createElement(component, newProps, this.renderNumberElement());
    }
  }]);
