...
.@{progress-prefix-cls} {
  ...
  &-status-exception {
    .@{progress-prefix-cls}-bg {
      background-color: @process-exception-color;
    }
    .@{progress-prefix-cls}-text {
      color: @process-exception-color;
    }
    .@{progress-prefix-cls}-circle-path {
      stroke: @process-exception-color;
    }
  }

  &-status-success {
    .@{progress-prefix-cls}-bg {
      background-color: @process-success-color;
    }
    .@{progress-prefix-cls}-text {
      color: @process-success-color;
    }
    .@{progress-prefix-cls}-circle-path {
      stroke: @process-success-color;
    }
  }
