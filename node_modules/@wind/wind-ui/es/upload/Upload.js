...
var Upload = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Upload, [{
    ...
    value: function render() {
      ...
      var uploadList = showUploadList ? /*#__PURE__*/React.createElement(UploadList, {
        listType: listType,
      ...
      if (type === 'drag') {
        ...
        var dragCls = classNames(prefixCls, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-drag"), true), _defineProperty(_classNames, "".concat(prefixCls, "-drag-uploading"), this.state.fileList.some(function (file) {
