...
import ToTopO from "@wind/icons/es/icons/ToTopO";
  ...
  _createClass(BackTop, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          prefixCls = _this$props2$prefixCl === void 0 ? 'w-back-top' : _this$props2$prefixCl,
      ...
      }, /*#__PURE__*/React.createElement(ToTopO, {
        className: "".concat(prefixCls, "-icon")
      })); // fix https://fb.me/react-unknown-prop

      var divProps = omit(this.props, ['prefixCls', 'className', 'children', 'visibilityHeight']);
      var backTopBtn = this.state.visible ? /*#__PURE__*/React.createElement("div", _extends({}, divProps, {
        className: classString,
        onClick: this.scrollToTop
      }), children || defaultElement) : null; // 动画似乎与opacity冲突
