...
import ArrowUpO from "@wind/icons/es/icons/ArrowUpO";
import ArrowDownO from "@wind/icons/es/icons/ArrowDownO";
import RightO from "@wind/icons/es/icons/RightO"; // import UpO from '@wind/icons/lib/icons/UpO';
...
function DefaultExpandIcon(props) {
  ...
  if (props.expandable) {
    iconNode = /*#__PURE__*/React.createElement(RightO, {
  ...
  _createClass(Table, [{
    ...
    value: function renderColumnsDropdown(columns) {
      ...
      return treeMap(columns, function (originColumn, i) {
        ...
        if (column.sorter) {
          ...
          sortButton = isAscend ? /*#__PURE__*/React.createElement("span", {
            className: "".concat(prefixCls, "-column-sorter-icon ").concat(prefixCls, "-column-sorter-up"),
            title: "\u2191"
          }, /*#__PURE__*/React.createElement(ArrowUpO, null)) : isDescend ? /*#__PURE__*/React.createElement("span", {
            className: "".concat(prefixCls, "-column-sorter-icon ").concat(prefixCls, "-column-sorter-down"),
            title: "\u2193"
          }, /*#__PURE__*/React.createElement(ArrowDownO, null)) : null;
        ...
        }, sortButton, column.title, /*#__PURE__*/React.createElement("span", {
    ...
    value: function renderPagination() {
      ...
      return total > 0 ? /*#__PURE__*/React.createElement(Pagination, _extends({
        ...
        className: classNames(pagination.className, "".concat(this.props.prefixCls, "-pagination")),
    ...
    value: function render() {
      ...
      var classString = classNames((_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-").concat(this.props.size), true), _defineProperty(_classNames2, "".concat(prefixCls, "-bordered-").concat(bordered), bordered), _defineProperty(_classNames2, "".concat(prefixCls, "-empty"), !data.length), _defineProperty(_classNames2, "".concat(prefixCls, "-without-column-header"), !showHeader), _defineProperty(_classNames2, "".concat(prefixCls, "-striped"), striped), _classNames2));
      ...
      columns = treeMap(columns, function (column) {
        var _classNames3;

        var newColumn = _extends({}, column);

        newColumn.className = classNames((_classNames3 = {}, _defineProperty(_classNames3, "".concat(prefixCls, "-align-").concat(newColumn.align), newColumn.align), _defineProperty(_classNames3, "".concat(prefixCls, "-header-align-").concat(newColumn.headerAlign), newColumn.headerAlign), _classNames3), newColumn.className);
        return newColumn;
      }); // 原代码如此，未使用treeMap
      ...
      columns = columns.map(function (column, i) {
        ...
        if (newColumn.children) {
          if (pre && !pre.children) {
            treeForEachLast([pre], function (col) {
              col.className = classNames(col.className, "".concat(prefixCls, "-group-divider"));
            });
          } // 最后一列不加


          if (i !== cLen - 1) {
            treeForEachLast([newColumn], function (col) {
              col.className = classNames(col.className, "".concat(prefixCls, "-group-divider"));
            });
          }
        }
      ...
      treeForEachLast(columns, function (col) {
        col.className = classNames(col.className, "".concat(prefixCls, "-last-column"));
      ...
      var table = /*#__PURE__*/React.createElement(RcTable, _extends({
        key: "table"
      }, restProps, {
        prefixCls: prefixCls,
        data: data,
