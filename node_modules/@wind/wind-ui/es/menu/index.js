...
var Menu = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Menu, [{
    ...
    value: function getMenuOpenAnimation(menuMode) {
      ...
      if (openAnimation === undefined && openTransitionName === undefined) {
        switch (menuMode) {
          ...
          case 'inline':
            menuOpenAnimation = _extends(_extends({}, animation), {
    ...
    value: function render() {
      ...
      var menuClassName = classNames(className, "".concat(prefixCls, "-").concat(theme), (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-").concat(size), size && size !== 'default'), _defineProperty(_classNames, "".concat(prefixCls, "-inline-collapsed"), this.getInlineCollapsed()), _classNames));
      var menuProps = {
      ...
      return /*#__PURE__*/React.createElement(RcMenu, _extends({
        expandIcon: /*#__PURE__*/React.createElement(DownO, {
