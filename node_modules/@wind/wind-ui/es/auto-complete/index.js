  ...
  _createClass(AutoComplete, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          optionFilterProp = _this$props.optionFilterProp,
          dataSource = _this$props.dataSource,
          children = _this$props.children;
      var options,
          inputElement = /*#__PURE__*/React.createElement(InputElement, null, /*#__PURE__*/React.createElement("input", null)),
          isCustomizeInput = false;

      if (children && /*#__PURE__*/React.isValidElement(children) && children.type !== Option) {
        inputElement = /*#__PURE__*/React.createElement(InputElement, inputElement.props, React.Children.only(this.props.children));
        isCustomizeInput = true;
      }

      var cls = classNames((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-lg"), size === 'large'), _defineProperty(_classNames, "".concat(prefixCls, "-sm"), size === 'small'), _defineProperty(_classNames, className, !!className), _defineProperty(_classNames, "".concat(prefixCls, "-show-search"), true), _defineProperty(_classNames, "".concat(prefixCls, "-auto-complete"), true), _defineProperty(_classNames, "".concat(prefixCls, "-customize-input"), isCustomizeInput), _classNames));
