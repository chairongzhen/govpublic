...
var Resizer = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Resizer, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_reactDraggable.DraggableCore // axis={(direction === 'n' || direction === 's') ? 'y' : 'x'}
      , {
        ...
        ref: this.saveRef,
        className: (0, _classnames2["default"])(className, prefixCls, (_classnames = {}, _defineProperty(_classnames, "".concat(prefixCls, "-folded"), folded), _defineProperty(_classnames, "".concat(prefixCls, "-").concat(direction), true), _defineProperty(_classnames, "".concat(prefixCls, "-").concat(theme), true), _defineProperty(_classnames, "".concat(prefixCls, "-type-").concat(type), type != null), _classnames)),
        style: style
      }, foldable ? /*#__PURE__*/_react["default"].createElement("span", {
  ...
  return Resizer;
}(_react["default"].Component); // static propTypes = {
