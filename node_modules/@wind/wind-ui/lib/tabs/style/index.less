...
@tabs-block-head-hover-bg: #e8e8e9;
...
.@{tab-prefix-cls} {
  ...
  &-bar {
    border-bottom: @border-width-base @border-style-base #DDDDDD;//@border-color-split
    // margin-bottom: 16px;
    outline: none;
  ...
  &-small-bar {
    .@{tab-prefix-cls}-nav-container {
      ...
      line-height: @tabs-line-height-sm;
    }
...
.@{tab-prefix-cls} {
  ...
  &&-block > &-bar {
    .@{tab-prefix-cls}-tab {
      &:hover {
        background-color: @tabs-block-head-hover-bg;
        color:inherit;
      }
