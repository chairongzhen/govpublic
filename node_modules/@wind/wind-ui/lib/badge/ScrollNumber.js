...
var ScrollNumber = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ScrollNumber, [{
    ...
    value: function renderNumberList(position) {
      ...
      for (var i = 0; i < 30; i++) {
        ...
        childrenToReturn.push( /*#__PURE__*/_react["default"].createElement("p", {
          key: i.toString(),
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          component = _this$props$component === void 0 ? 'sup' : _this$props$component; // fix https://fb.me/react-unknown-prop

      var restProps = (0, _omit["default"])(this.props, ['count', 'onAnimated', 'component', 'prefixCls']);

      var newProps = _extends(_extends({}, restProps), {
        className: (0, _classnames["default"])((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls), !!prefixCls), _defineProperty(_classNames, "".concat(className), !!className), _classNames)),
        title: count
      ...
      return /*#__PURE__*/(0, _react.createElement)(component, newProps, this.renderNumberElement());
    }
  }]);
