...
.@{steps-prefix-cls} {
  ...
  .@{steps-prefix-cls}-item {
    ...
    &.@{steps-prefix-cls}-item-status {
      .@{steps-prefix-cls}-item-status-icon {
        // font-size: @font-size-ll;
        transform: scale(1.1); // 否则圈看起来不一样大
      }
    }
  ...
  &.@{steps-prefix-cls}-small {
    .@{steps-prefix-cls}-head-inner {
      ...
      line-height: @steps-small-icon-size - @border-width-base * 2;
      text-align: center;
      border-radius: @steps-small-icon-size;
      font-size: @font-size-base;
      margin-right: 10px;
      // > .@{steps-prefix-cls}-icon .@{wind-icons-prefix} {
...
.@{steps-prefix-cls}-dot {
  ...
  .@{steps-prefix-cls}-head {
    ...
    &-inner {
      ...
      .@{steps-prefix-cls}-icon-dot {
        ...
        width: 100%;
        height: 100%;
        border-radius: 50%;//@steps-dot-size / 2
        position: relative;
        &:after {
          content: '';
  ...
  &.@{steps-prefix-cls}-vertical {
    ...
    .@{steps-prefix-cls}-item .@{steps-prefix-cls}-step {
      display:block;
      width:auto;
      text-align: left;
    }
