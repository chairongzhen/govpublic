...
var Card = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      var classString = (0, _classnames["default"])(prefixCls, className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-loading"), loading), _defineProperty(_classNames, "".concat(prefixCls, "-bordered"), bordered), _defineProperty(_classNames, "".concat(prefixCls, "-hoverable"), hoverable), _defineProperty(_classNames, "".concat(prefixCls, "-shadowed"), shadowed), _defineProperty(_classNames, "".concat(prefixCls, "-wider-padding"), this.state.widerPadding), _defineProperty(_classNames, "".concat(prefixCls, "-padding-transition"), this.updateWiderPaddingCalled), _defineProperty(_classNames, "".concat(prefixCls, "-contain-grid"), this.isContainGrid()), _defineProperty(_classNames, "".concat(prefixCls, "-selected"), selected), _defineProperty(_classNames, "".concat(prefixCls, "-").concat(size), size != null && size !== 'default'), _classNames));
      var dividerClass = (0, _classnames["default"])("".concat(prefixCls, "-divider"), "".concat(prefixCls, "-divider-").concat(divider || 'solid'));
      ...
      if (title || extra) {
        ...
        }, title) : null, extra ? /*#__PURE__*/_react["default"].createElement("div", {
          className: "".concat(prefixCls, "-extra")
        }, extra) : null);
      }

      return /*#__PURE__*/_react["default"].createElement("div", _extends({}, others, {
        className: (0, _classnames["default"])(classString, head ? '' : "".concat(prefixCls, "-no-title")),
        ref: this.saveRef
      }), head, head ? /*#__PURE__*/_react["default"].createElement("div", {
