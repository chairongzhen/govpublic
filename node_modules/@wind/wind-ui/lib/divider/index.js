  ...
  _createClass(Divider, [{
    ...
    value: function render() {
      ...
      var _a = this.props,
          ...
          restProps = __rest(_a, ["prefixCls", "type", "orientation", "className", "children", "dashed", "color", "style"]);

      var orientationPrefix = orientation && orientation.length > 0 ? "-".concat(orientation) : orientation;
