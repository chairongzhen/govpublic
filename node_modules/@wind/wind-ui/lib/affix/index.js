...
var Affix = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Affix, [{
    ...
    value: function updatePosition(e) {
      ...
      var affixNode = _reactDom["default"].findDOMNode(this);
      ...
      if (scrollTop > elemOffset.top - offsetTop && offsetMode.top) {
        ...
        if (e.type === 'resize' && affixStyle && affixStyle.position === 'fixed' && affixNode.offsetWidth) {
          this.setAffixStyle(e, _extends(_extends({}, affixStyle), {
    ...
    value: function render() {
      var className = (0, _classnames["default"])(_defineProperty({}, this.props.prefixCls || 'w-affix', this.state.affixStyle));
      var props = (0, _omit["default"])(this.props, ['prefixCls', 'offsetTop', 'offsetBottom', 'target', 'onChange']);

      var placeholderStyle = _extends(_extends({}, this.state.placeholderStyle), this.props.style);
