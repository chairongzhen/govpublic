...
function wrapPicker(Picker, defaultFormat) {
  ...
  return _a = /*#__PURE__*/function (_React$Component) {
    ...
    function PickerWrapper() {
      ...
      _this.handleOpenChange = function (open) {
        ...
        if (toggleOpen) {
          (0, _warning["default"])(false, '`toggleOpen` is deprecated and will be removed in the future, ' + 'please use `onOpenChange` instead, see: https://u.ant.design/date-picker-on-open-change');
          toggleOpen({
            open: open
          });
        }
    ...
    _createClass(PickerWrapper, [{
      ...
      value: function render() {
        ...
        var pickerClass = (0, _classnames["default"])(_defineProperty({}, "".concat(prefixCls, "-picker"), true));
        var pickerInputClass = (0, _classnames["default"])("".concat(prefixCls, "-picker-input"), inputPrefixCls, (_classNames2 = {}, _defineProperty(_classNames2, "".concat(inputPrefixCls, "-lg"), props.size === 'large'), _defineProperty(_classNames2, "".concat(inputPrefixCls, "-sm"), props.size === 'small'), _defineProperty(_classNames2, "".concat(inputPrefixCls, "-disabled"), props.disabled), _classNames2));
        ...
        var timePicker = props.showTime ? /*#__PURE__*/_react["default"].createElement(_Panel["default"], _extends({}, rcTimePickerProps, props.showTime, {
          prefixCls: "".concat(prefixCls, "-time-picker"),
          className: timePickerCls,
          placeholder: locale.timePickerLocale.placeholder,
          transitionName: "slide-up"
        })) : null;
        return /*#__PURE__*/_react["default"].createElement(Picker, _extends({}, props, {
  ...
  }(_react["default"].Component), _a.contextTypes = {
