...
var _CalendarO = _interopRequireDefault(require("@wind/icons/lib/icons/CalendarO"));
...
var RangePicker = /*#__PURE__*/function (_React$Component) {
  ...
  function RangePicker(props) {
    ...
    _this.renderFooter = function () {
      ...
      var customFooter = renderExtraFooter ? /*#__PURE__*/_react["default"].createElement("div", {
      ...
      var rangeNode = /*#__PURE__*/_react["default"].createElement("div", {
    ...
    if (value[0] && !_moment["default"].isMoment(value[0]) || value[1] && !_moment["default"].isMoment(value[1])) {
    ...
    _this.state = {
      value: value,
      showDate: pickerValueAdapter(pickerValue || (0, _moment["default"])()),
      open: props.open,
      hoverValue: []
    };
    return _this;
  ...
  _createClass(RangePicker, [{
    ...
    value: function render() {
      ...
      var value = state.value,
          ...
          open = state.open;
      var localeCode = (0, _getLocale.getLocaleCode)(context); // value 为 null 时 local 传不进去
      ...
      var calendar = /*#__PURE__*/_react["default"].createElement(_RangeCalendar["default"] // showDateInput={false}
      ...
      var clearIcon = !props.disabled && props.allowClear && value && (value[0] || value[1]) ? /*#__PURE__*/_react["default"].createElement(_CloseCircleF["default"], {
      ...
      var input = function input(_ref2) {
        ...
        }, /*#__PURE__*/_react["default"].createElement(_CalendarO["default"], null)));
      };

      return /*#__PURE__*/_react["default"].createElement("span", {
        className: (0, _classnames["default"])(props.className, props.pickerClass),
        style: _extends(_extends({}, style), pickerStyle)
      }, /*#__PURE__*/_react["default"].createElement(_Picker["default"] // align={popupAlign}
