...
.@{slider-prefix-cls} {
  ...
  &-track {
    ...
    background-color: @primary-color;//tint(@primary-color, 60%);
    transition: background-color 0.3s ease;
  }
  ...
  &-handle {
    ...
    cursor: pointer;
    border-radius: 50%;
    border: solid 1px @primary-color;//tint(@primary-color, 50%)
  ...
  //     background-color: @primary-5;//tint(@primary-color, 40%)
  //   }
  ...
  &-dot {
    ...
    &-active {
      border-color: @primary-color;//tint(@primary-color, 50%)
    }
  }
