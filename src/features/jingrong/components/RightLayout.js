...
import { Carousel } from '@wind/wind-ui';
    ...
    <div className="right">
      <div className="boxContainer">
        <div className="box ">
          ...
          <div className="right-tab-div" style={{ display: tabDisplay === 1 ? 'flex' : 'none' }}>
            <div></div>
          ...
          <div className="right-tab-div" style={{ display: tabDisplay === 2 ? 'flex' : 'none' }}>
            <div></div>
            {recommend?.length > 0 ? (
              recommend.map((item, index) => {
                return (
                  <div key={index} className="news">
                    <div className="mouse" onClick={() => newShow(item[2])} title={item[0].trim()}>
                      <div className="news-title">{item[0].trim()}</div>
                    </div>
                    <div>{item[1].trim()}</div>
                  </div>
          ...
          <div className="right-tab-div" style={{ display: tabDisplay === 3 ? 'flex' : 'none' }}>
            <div></div>
            {tabDisplay === 3 ? (
                          ...
                          return (
                            ...
                            >
                              <div className="companyName">
                                <div className="companyName-name">{item.companyName}</div>
                                <div>
                                  {item.newsScore.map((item, index) => {
                                    return <img src={star} alt="星级" key={index} />;
                                  })}
                                </div>
                              </div>

                              <div className="sentences" title={item.sentences}>
                                {item.sentences}
                              </div>
