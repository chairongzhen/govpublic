...
import { Dropdown, Button, Radio, Checkbox, Icon, Menu } from '@wind/wind-ui';
  ...
  return (
    <div className="dashboard-industry-balance">
      <div>
        <div>
          <div>
            <Dropdown overlay={menu1} placement="bottomCenter" overlayClassName="overlayClassName">
              <Button
                style={{
                  width: '0.78125rem',
                  height: '0.15625rem',
      ...
      <div>
        <div>
          <div>
            <Dropdown overlay={menu2} placement="bottomCenter" overlayClassName="overlayClassName">
              <Button
                style={{
                  width: '0.78125rem',
                  height: '0.15625rem',
