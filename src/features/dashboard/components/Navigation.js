...
import { Menu, Dropdown, Button, Radio, Checkbox, Icon } from 'antd';
...
export default function Navigation({ children, location }) {
    ...
    const generatePageCom = () => {
        ...
        const PageCom =
            pageComponents[currentPage.components] || pageComponents['EnterpriseOverview'];
            ...
            <div className='overview-content'>
                ...
                <div className='content-foot'>
                    <div className='foot-data'>
                        <div
                            style={
                                currentPage?.components === 'ListedCompanies'
                                    ? {}
                                    : { display: 'none' }
                            }
                        >
