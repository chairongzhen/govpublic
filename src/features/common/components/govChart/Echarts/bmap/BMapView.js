...
var _default = echarts.extendComponentView({
  ...
  render: function (bMapModel, ecModel, api) {
    ...
    var moveHandler = function (type, target) {
      ...
      var offsetEl = null;
      if (viewportRoot.parentNode && viewportRoot.parentNode.parentNode && viewportRoot.parentNode.parentNode.parentNode) {
        offsetEl = viewportRoot.parentNode.parentNode.parentNode;
      } else {
        console.log('viewportRoot.parentNode is null', viewportRoot);
      }
      if (!offsetEl) {
        return;
      }
